...
function FAQ() {
  return (
    ...
    <div className="container">
      ...
      <h3>What should I get you as a gift?</h3>
      <p>You reallllly don't need to get us a gift. Seriously, it's not necessary. That being said, we just bought a house and are kinda broke from that so if you insist on giving us money, we will ... spend it.</p>
      <h3>Can I bring my kids?</h3>
      <p>No.</p>
      <h3>Can I bring my a plus 1?</h3>
